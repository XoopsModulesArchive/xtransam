...
//  ------------------------------------------------------------------------ //
	function languagesForm_display() {
		...
		$ele_select = new XoopsFormSelect(_AM_XTRANSAM_PROVIDER, 'provider[0]');
		define(_AM_XTRANSAM_PROV_GOOGLE, 'google'); 
		define(_AM_XTRANSAM_PROV_GOOGLEDESC, 'Google API');
		$ele_select->addOption(_AM_XTRANSAM_PROV_GOOGLE, _AM_XTRANSAM_PROV_GOOGLEDESC);
