...
//  ------------------------------------------------------------------------ //
	...
	define('_MI_XTRANSAM_XTRANSAM_NAME', 'Langauge Translator');
	define('_MI_XTRANSAM_XTRANSAM_DESC', 'Langauge Translator is used to translate language file in xoops.<br><em>Written in memory of John Milner (Microsoft Australia)</em>');	
