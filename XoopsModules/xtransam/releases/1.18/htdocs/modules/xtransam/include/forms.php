...
//  ------------------------------------------------------------------------ //
	function languagesForm_display() {
		...
		$ele_select = new XoopsFormCheckbox(_AM_XTRANSAM_PROVIDER, 'providers[0]');
		$ele_select->addOption('google', _MI_XTRANSAM_PROVIDER_REST_GOOGLE);
		$ele_select->addOption('mymemory', _MI_XTRANSAM_PROVIDER_REST_MYMEMORY);
		$ele_select->addOption('bing', _MI_XTRANSAM_PROVIDER_REST_BING);
		...
		foreach ($langs as $lang) {
			...
			$ele_select->setValue($lang->getVar('providers'));
